...
grep -q 'force_build:' "$ROOT_DIR/.github/workflows/build-release.yml"
grep -q 'FORCE_BUILD:' "$ROOT_DIR/.github/workflows/build-release.yml"
grep -q 'Force build enabled' "$ROOT_DIR/.github/workflows/build-release.yml"
...
grep -q 'check-upstream-state.sh both' "$ROOT_DIR/.github/workflows/check-upstream-release.yml"
grep -q 'agent_built' "$ROOT_DIR/scripts/build-release.sh"
grep -q 'latest_studio_web_tag' "$ROOT_DIR/scripts/check-upstream-state.sh"
grep -q 'unified_release_tags' "$ROOT_DIR/scripts/check-upstream-state.sh"
grep -q 'last_successful_upstream' "$ROOT_DIR/scripts/check-upstream-state.sh"
grep -q 'gh release download' "$ROOT_DIR/scripts/check-upstream-state.sh"
