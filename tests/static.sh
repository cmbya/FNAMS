...
grep -q 'agent_upstream_tag' "$ROOT_DIR/.github/workflows/build-release.yml"
grep -q 'studio_upstream_tag' "$ROOT_DIR/.github/workflows/build-release.yml"
grep -q 'upstream_tag' "$ROOT_DIR/.github/workflows/build-release.yml"
grep -q 'gh release edit "$tag" --title "$title"' "$ROOT_DIR/.github/workflows/build-release.yml"
