...
1. 安装 `HermesAgent-0.1.4-fnOS-x86_64.fpk`。
2. 在 Agent 配置中选择一个 fnOS 授权目录，并配置模型/API 和消息平台。
3. 安装 `HermesStudio-0.1.4-fnOS-x86_64.fpk`。
...
- 包版本从 `0.1.0` 开始，当前安装兼容性修复版本为 `0.1.4`，由 `FPK_VERSION` 控制。
